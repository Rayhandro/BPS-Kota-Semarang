...
<body>
    <!-- Navbar -->
    <nav class="navbar navbar-expand-lg navbar-dark px-5 shadow-navbar">
        <a class="navbar-brand" href="#"><img src="<?php echo base_url('assets/template/'); ?>img/bps.png" alt="" width="60px"><span>BPS Kota Semarang</span></a>
